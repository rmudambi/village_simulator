from village_simulator.simulation.components.demographics import Demographics
...
from village_simulator.simulation.components.farming import TemperatureEffect, Wheat
